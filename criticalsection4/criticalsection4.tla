...
(****************************************************************************)
(* PlusCal implementation of Algorithm 3.9 from M. Ben-Ari: Principles of   *)
(* Concurrent and Distributed Programming. Second Edition, page 59, 2006.   *)
(*                                                                          *)
(* This algorithm tries to implement mutual exclusion.                      *)
(* It guarantees mutual exclusion. It is deadlock free. However, it is      *)
(* *not*starvation free.                                                    *)
(****************************************************************************)
...
--algorithm criticalsection4
{
    ...
    process(P = 1) {
	    ...
	    p6: skip; \* critical section
	    p7: wantp := FALSE;
        } 
    }

    \* First process (name Q, pid 2)
    process(Q = 2) {
        q0: while (TRUE) {
...
MutualExclusion == [] ~ (pc[1] = "p6" /\ pc[2] = "q6")
...
NoStarvationP == (pc[1] = "p3") ~> (pc[1] = "p6") 
NoStarvationQ == (pc[2] = "q3") ~> (pc[2] = "q6") 
