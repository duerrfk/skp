...
(****************************************************************************)
(* PlusCal implementation of Algorithm 3.8 from M. Ben-Ari: Principles of   *)
(* Concurrent and Distributed Programming. Second Edition, page 57, 2006.   *)
(*                                                                          *)
(* This algorithm tries to implement mutual exclusion.                      *)
(* It guarantees mutual exclusion. However, it is *not* deadlock free.      *)
(****************************************************************************)
...
NoStarvationP == (pc[1] = "p3") ~> (pc[1] = "p4") 
NoStarvationQ == (pc[2] = "q3") ~> (pc[2] = "q4") 
